...
router.get('/', (req, res, next) => {
    request.get({
        url: "https://app-15086.on-aptible.com/api/channels/47755bd5-d542-4256-80fb-63b92b4d93b6/messages/?includeContent=true&offset=0&limit=20",
        headers: {
    ...
    }, { proxy: 'https://10.23.201.11:3128' }, (error, response, body) => {
        if (error) {
